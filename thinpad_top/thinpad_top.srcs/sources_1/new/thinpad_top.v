...
rom_top rom_top0(
            .clk_input(clk_o),
            .rst_input(rst),
            .wb_addr_input(rom_addr_o),
            .wb_data_input(rom_data_o),
            .wb_data_output(rom_data_i),
            .wb_we_input(rom_we_o),
            .wb_stb_input(rom_stb_o), 
            .wb_cyc_input(rom_cyc_o), 
            .wb_ack_output(rom_ack_i), 
            .wb_sel_input(rom_sel_o)
    );
...
wire [7:0] vga_data_input = (serial_we_o)?serial_data_o:serial_data_i;
vga #(12, 800, 856, 976, 1040, 592, 637, 643, 666, 1, 1) vga800x600at75 (
    .clk(clk_50M), 
    .rst(rst),
